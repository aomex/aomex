...
import { MongoDecimal128Validator as TargetValidator } from '../../src';
import type { TransformedValidator, Validator } from '@aomex/common';
import { mongo } from 'mongoose';

type DefaultType = mongo.Decimal128;
...
// 默认值 decimal
{
  const v = validator.optional().default(mongo.Decimal128.fromString('123'));
  expectType<TargetValidator<any>>(v);
  expectType<TypeEqual<DefaultType, Validator.Infer<typeof v>>>(true);
}
